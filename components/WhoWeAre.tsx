const WhoWeAre = () => {
  return (
    <div className="w-full max-w-[90%] lg:max-w-[863px] mx-auto mt-[52px] mb-[69px] md:mb-[134px] px-[35px] md:px-0">
      <h3 className="uppercase text-black text-[18px] md:text-[20px] leading-[23px]">
        WHO WE ARE
      </h3>
      <p className="mt-[46px] font-bold text-[18px] md:text-[26px] leading-[30px] text-black">
      ...
      <br />
      <br />
      <h3 className="font-bold text-[16px] md:text-[26px] leading-[30px] text-black">
        Our consumer marketplace
      </h3>
      <br />
      <p className="font-light text-[16px] md:text-[20px] leading-[30px] text-black">
